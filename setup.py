...
setup(
    name='kimocoin-python',
    version='0.1',
    description='Friendly KimoCoin JSON-RPC API binding for Python',
    ...
    maintainer='KimoCoin Developers',
    maintainer_email='support@kimocoin.com',
    url='http://github.com/KimoCoin',
    classifiers=[
